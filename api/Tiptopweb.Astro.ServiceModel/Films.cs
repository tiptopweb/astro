...
[Route("/films")]
public class Films : QueryDb<TtwArticle>
{
    [ValidateEqual(1)]
...
[Alias("TtwArticle")]
public class TtwArticle : IHasId<int>
{
    [Alias("Id")]
    [AutoIncrement]
    ...
    public TtwArticleTitle CpxTitle { get; set; }
    public TtwArticleText CpxText { get; set; }
    public TtwArticleParam CpxParam { get; set; }

    public TtwArticle()
    {
        CpxTitle = new TtwArticleTitle();
        CpxText = new TtwArticleText();
        CpxParam = new TtwArticleParam();
    }
}

public class TtwArticleTitle
{
